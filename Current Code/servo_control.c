...
int main(void) {
    ...
    servo_t s = {
      ...
      s.cal_fwd[0]  = (cal_point_t){ -180.0, 1150.0  };
      s.cal_fwd[1]  = (cal_point_t){ -120.0, 1355.0  };
      s.cal_fwd[2]  = (cal_point_t){ -110.0, 1386.0  };
      s.cal_fwd[3]  = (cal_point_t){ -100.0, 1417.0  };
      s.cal_fwd[4]  = (cal_point_t){ -90.0,  1457.0  };
      s.cal_fwd[5]  = (cal_point_t){ -80.0,  1489.0  };
      s.cal_fwd[6]  = (cal_point_t){ -70.0,  1528.0  };
      s.cal_fwd[7]  = (cal_point_t){ -60.0,  1563.0  };
      s.cal_fwd[8]  = (cal_point_t){ -50.0,  1598.0  };
      s.cal_fwd[9]  = (cal_point_t){ -40.0,  1637.0  };
      s.cal_fwd[10] = (cal_point_t){ -30.0,  1671.0  };
      s.cal_fwd[11] = (cal_point_t){ -20.0,  1703.0  };
      s.cal_fwd[12] = (cal_point_t){ -10.0,  1739.0  };
      s.cal_fwd[13] = (cal_point_t){  0.0,   1775.0  };
      s.cal_fwd[14] = (cal_point_t){ 10.0,   1810.0  };
      s.cal_fwd[15] = (cal_point_t){ 20.0,   1842.0  };
      s.cal_fwd[16] = (cal_point_t){ 30.0,   1873.0  };
      s.cal_fwd[17] = (cal_point_t){ 40.0,   1907.75 };
      s.cal_fwd[18] = (cal_point_t){ 50.0,   1941.0  };
      s.cal_fwd[19] = (cal_point_t){ 60.0,   1972.0  };
      s.cal_fwd[20] = (cal_point_t){ 70.0,   2004.0  };
      s.cal_fwd[21] = (cal_point_t){ 80.0,   2042.0  };
      s.cal_fwd[22] = (cal_point_t){ 90.0,   2073.0  };
      s.cal_fwd[23] = (cal_point_t){ 100.0,  2106.0  };
      s.cal_fwd[24] = (cal_point_t){ 110.0,  2135.0 };
      s.cal_fwd[25] = (cal_point_t){ 120.0,  2168.0  };
      s.cal_fwd[26] = (cal_point_t){ 180.0,  2372.0  };

      s.cal_rev[0]  = (cal_point_t){ -180.0, 1163.0  };
      s.cal_rev[1]  = (cal_point_t){ -120.0, 1357.0  };
      s.cal_rev[2]  = (cal_point_t){ -110.0, 1393.0  };
      s.cal_rev[3]  = (cal_point_t){ -100.0, 1429.0  };
      s.cal_rev[4]  = (cal_point_t){ -90.0,  1460.0  };
      s.cal_rev[5]  = (cal_point_t){ -80.0,  1494.0  };
      s.cal_rev[6]  = (cal_point_t){ -70.0,  1533.0  };
      s.cal_rev[7]  = (cal_point_t){ -60.0,  1570.0  };
      s.cal_rev[8]  = (cal_point_t){ -50.0,  1604.0  };
      s.cal_rev[9]  = (cal_point_t){ -40.0,  1640.0  };
      s.cal_rev[10] = (cal_point_t){ -30.0,  1675.0  };
      s.cal_rev[11] = (cal_point_t){ -20.0,  1711.0  };
      s.cal_rev[12] = (cal_point_t){ -10.0,  1743.0  };
      s.cal_rev[13] = (cal_point_t){ 0.0,    1780.0  };
      s.cal_rev[14] = (cal_point_t){ 10.0,   1813.0  };
      s.cal_rev[15] = (cal_point_t){ 20.0,   1848.0  };
      s.cal_rev[16] = (cal_point_t){ 30.0,   1877.0  };
      s.cal_rev[17] = (cal_point_t){ 40.0,   1908.0  };
      s.cal_rev[18] = (cal_point_t){ 50.0,   1943.0  };
      s.cal_rev[19] = (cal_point_t){ 60.0,   1979.0  };
      s.cal_rev[20] = (cal_point_t){ 70.0,   2011.0  };
      s.cal_rev[21] = (cal_point_t){ 80.0,   2044.0  };
      s.cal_rev[22] = (cal_point_t){ 90.0,   2077.0  };
      s.cal_rev[23] = (cal_point_t){ 100.0,  2108.25 };
      s.cal_rev[24] = (cal_point_t){ 110.0,  2139.0  };
      s.cal_rev[25] = (cal_point_t){ 120.0,  2171.0  };
      s.cal_rev[26] = (cal_point_t){ 180.0,  2372.0  };
    ...
    while (!exiting) {
        ...
        if (!strcmp(cmd, "status")) {
            printf("pulse_us=%.2f  deg_pos(model)=%.2f  center_us=%.1f  clamp=[%.0f..%.0f]  sensor=%d  cal_points=%d\n",
                   s.pulse_us, s.deg_pos, s.center_us, s.min_us, s.max_us, sensor_gpio, s.cal_fwd_count, s.cal_rev_count);
            continue;
        }
